...
const PaginateComponent = ({ totalPages, currentPage, onPageChange }: { totalPages: number, currentPage: number, onPageChange: any }) => {
    ...
    // Update display pages when currentPage or totalPages change
    React.useEffect(() => {
        updateDisplayPages();
